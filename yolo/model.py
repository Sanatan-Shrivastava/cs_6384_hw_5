...
class YOLO(nn.Module):
    ...
    def create_modules(self):
        ...
        module.add_module("conv1", nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1))
        module.add_module("relu1", nn.ReLU(inplace=True))
        module.add_module("maxpool1", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv2", nn.Conv2d(16, 32, kernel_size=3, stride=1, padding=1))
        module.add_module("relu2", nn.ReLU(inplace=True))
        module.add_module("maxpool2", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv3", nn.Conv2d(32, 64, kernel_size=3, stride=1, padding=1))
        module.add_module("relu3", nn.ReLU(inplace=True))
        module.add_module("maxpool3", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv4", nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1))
        module.add_module("relu4", nn.ReLU(inplace=True))
        module.add_module("maxpool4", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv5", nn.Conv2d(128, 256, kernel_size=3, stride=1, padding=1))
        module.add_module("relu5", nn.ReLU(inplace=True))
        module.add_module("maxpool5", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv6", nn.Conv2d(256, 512, kernel_size=3, stride=1, padding=1))
        module.add_module("relu6", nn.ReLU(inplace=True))
        module.add_module("maxpool6", nn.MaxPool2d(kernel_size=2, stride=2))
        module.add_module("conv7", nn.Conv2d(512, 1024, kernel_size=3, stride=1, padding=1))
        module.add_module("relu7", nn.ReLU(inplace=True))
        module.add_module("conv8", nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1))
        module.add_module("relu8", nn.ReLU(inplace=True))
        module.add_module("conv9", nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1))
        module.add_module("relu9", nn.ReLU(inplace=True))
        
        module.add_module("flatten", nn.Flatten())
        module.add_module("fc1", nn.Linear(50176, 256))
        module.add_module("fc2", nn.Linear(256, 256))
        module.add_module("fc_output", nn.Linear(256, 7*7*(5*B + C)))
        module.add_module("sigmoid", nn.Sigmoid())
        ### ADD YOUR CODE HERE ###
